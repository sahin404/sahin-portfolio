  ...
  return (
    <nav className="flex items-center justify-between px-5 md:px-20 pt-3 text-white">
      ...
      <ul className="hidden items-center justify-between gap-10 md:flex">
        ...
        <Link to="/projects"> <li className="group flex  cursor-pointer flex-col">
...
{/* 
        ...
        <Link to="/contact"><li className="group flex  cursor-pointer flex-col">
          <button className="relative overflow-hidden p-4 rounded-3xl text-white">
            ...
            <span className="absolute inset-0 bg-gradient-to-r from-[#411086] to-[#8e42d6] opacity-0 transition-opacity duration-300 group-hover:opacity-100"></span>
